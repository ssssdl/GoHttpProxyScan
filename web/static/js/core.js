...
Core.menu={
    ...
    [{
        ...
        data: [[{
            text: "背景1",
            func: function() {
                $(this).attr("style",'background:url(./static/images/background.jpg) repeat right bottom transparent;');
            }
        }, {
            text: "背景2",
            func: function() {
                $(this).attr("style",'background:url(./static/images/background2.jpg) repeat right bottom transparent;');
            }       
        }]]
    }]
    ],
